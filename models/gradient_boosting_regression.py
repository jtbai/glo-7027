...
class GradientBoostingRegression(BaseModel):
    ...
    def _train(self, X_train, y_train):
        parametres = {'max_depth': [3, 5, 10], 'n_estimators': [250, 275, 280, 285, 290, 300]}
        grid_search = model_selection.GridSearchCV(ensemble.GradientBoostingRegressor(loss="huber"), parametres, cv=10, n_jobs=6, scoring="neg_mean_squared_error")
